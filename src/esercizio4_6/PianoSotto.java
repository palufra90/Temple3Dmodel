 ...
 * @author francesca
 */
public class PianoSotto extends Shape3D{ 
   protected Point3d v[] = null;
    protected TexCoord2f t[] = null;
    protected TriangleStripArray triangleStrips = null;
    
    public PianoSotto(Appearance ap){
        //creo la geometry
        v = new Point3d[4];
        v[0] = new Point3d(-12.0,0.0,-1.4);
        v[1] = new Point3d(12.0,0.0,-1.4);
        v[2] = new Point3d(-12.0,0.0,1.4);
        v[3] = new Point3d(12.0,0.0,1.4);
        
        t = new TexCoord2f[4];
        t[0] = new TexCoord2f(0,0);
        t[1] = new TexCoord2f(1,0);
        t[2] = new TexCoord2f(1f,1);
        t[3] = new TexCoord2f(0f,1f);
        //t[4] = new TexCoord2f(2.5f,0f);*/
        int[] stripCounts = {4};
        triangleStrips = new TriangleStripArray(4, GeometryArray.COORDINATES|GeometryArray.TEXTURE_COORDINATE_2, stripCounts);
